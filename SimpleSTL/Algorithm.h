...
namespace SimpleSTL {
	...
	void make_heap(RandomAccessIterator first, RandomAccessIterator last) {
		SimpleSTL::make_heap(first, last,
			typename SimpleSTL::less<SimpleSTL::iterator_traits<RandomAccessIterator>::value_type>());
	}
	template <class RandomAccessIterator, class Compare>
	void make_heap(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
		const auto range = last - first;
		for (auto cur = first + range / 2 - 1; cur >= first; --cur) {
			SimpleSTL::down(cur, last - 1, first, comp);
			if (cur == first) return;
		}
	}
	//********* [push_heap] ***************
	...
	void push_heap(RandomAccessIterator first, RandomAccessIterator last) {
		SimpleSTL::push_heap(first, last,
			SimpleSTL::less<typename SimpleSTL::iterator_traits<RandomAccessIterator>::value_type>());
	}
	template <class RandomAccessIterator, class Compare>
	void push_heap(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
		SimpleSTL::up(first, last - 1, first, comp);
	}
	//********* [pop_heap] ***************
	//********* [Algorithm Complexity: O(lgN)] ****************
	template <class RandomAccessIterator>
	void pop_heap(RandomAccessIterator first, RandomAccessIterator last) {
		SimpleSTL::pop_heap(first, last,
			SimpleSTL::less<typename SimpleSTL::iterator_traits<RandomAccessIterator>::value_type>());
	}
	template <class RandomAccessIterator, class Compare>
	void pop_heap(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
		SimpleSTL::swap(*first, *(last - 1));
		if (last - first >= 2)
			SimpleSTL::down(first, last - 2, first, comp);
	}
	//********* [sort_heap] ***************
	//********* [Algorithm Complexity: O(N)] ****************
	template <class RandomAccessIterator>
	void sort_heap(RandomAccessIterator first, RandomAccessIterator last) {
		return SimpleSTL::sort_heap(first, last,
			SimpleSTL::less<typename SimpleSTL::iterator_traits<RandomAccessIterator>::value_type>());
	}
	template <class RandomAccessIterator, class Compare>
	void sort_heap(RandomAccessIterator first, RandomAccessIterator last, Compare comp) {
		for (auto cur = last; cur != first; --cur) {
			SimpleSTL::pop_heap(first, cur, comp);
		}
	}
	//********* [is_heap] ***************
	//********* [Algorithm Complexity: O(N)] ****************
	...
	bool is_heap(RandomAccessIterator first, RandomAccessIterator last) {
		return SimpleSTL::is_heap(first, last,
			SimpleSTL::less<typename SimpleSTL::iterator_traits<RandomAccessIterator>::value_type>());
	}
	template <class RandomAccessIterator, class Compare>
	...
	ForwardIterator adjacent_find(ForwardIterator first, ForwardIterator last) {
		//SimpleSTL::equal_to<typename SimpleSTL::iterator_traits<ForwardIterator1>::value_type>());

		//return SimpleSTL::adjacent_find(first, last,
		//	SimpleSTL::equal_to<iterator_traits<typename ForwardIterator>::value_type>());

		return SimpleSTL::adjacent_find(first, last,
			SimpleSTL::equal_to<typename SimpleSTL::iterator_traits<ForwardIterator>::value_type>());
	}
	...
	pair<InputIterator1, InputIterator2>
		...
		return SimpleSTL::make_pair(first1, first2);
	}
	...
	bool equal(InputIterator1 first1, InputIterator1 last1,
		...
		return SimpleSTL::equal(first1, last1, first2, SimpleSTL::equal_to<typename SimpleSTL::iterator_traits<InputIterator1>::value_type>());
	}
	template <class InputIterator1, class InputIterator2, class BinaryPredicate>
	bool equal(InputIterator1 first1, InputIterator1 last1,
		InputIterator2 first2, BinaryPredicate pred) {
	...
	bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1,
		...
		return SimpleSTL::is_permutation(first1, last1, first2,
			SimpleSTL::equal_to<typename SimpleSTL::iterator_traits<ForwardIterator1>::value_type>());
	}
	template <class ForwardIterator1, class ForwardIterator2, class BinaryPredicate>
	bool is_permutation(ForwardIterator1 first1, ForwardIterator1 last1,
		...
		auto res = SimpleSTL::mismatch(first1, last1, first2, pred);
		...
		for (auto it1 = first1; it1 != last1; ++it1) {
			if (SimpleSTL::find_if(first1, it1, [&](decltype(*first1) val) {return pred(val, *it1); }) == it1) {
				auto n = SimpleSTL::count(first2, last2, *it1);
				if (n == 0 || SimpleSTL::count(it1, last1, *it1) != n)
					return false;
			}
		}
		return true;
	...
	ForwardIterator1 search(ForwardIterator1 first1, ForwardIterator1 last1,
		ForwardIterator2 first2, ForwardIterator2 last2) {
		return SimpleSTL::search(first1, last1, first2, last2,
			SimpleSTL::equal_to<typename SimpleSTL::iterator_traits<ForwardIterator1>::value_type>());
	}
	template <class ForwardIterator1, class ForwardIterator2, class BinaryPredicate>
	ForwardIterator1 search(ForwardIterator1 first1, ForwardIterator1 last1,
	...
	OutputIterator _copy(InputIterator first, InputIterator last, OutputIterator result, T*) {
		typedef typename SimpleSTL::_type_traits<T>::is_POD_type is_pod;
